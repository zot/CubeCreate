...
/**
 * @def LUA_EMBED_STD
 * @brief Wrapper over LUA_EMBED_* autogenerated functions used to bind a simple function call.
 * @param name Name of embedded lua function
 * @param func Name of function to call
 * @param type_codes Argument types for function - LUA_EMBED_XXX.
 * @param ... Specifies arguments themselves.
 * 
 * This macro wraps over LUA_EMBED_XXX.
 * It basically calls a function specified by @p name, not returning anything, just passing it stuff.
 * Example:
 * @code
 * LUA_EMBED_STD(texAlpha, texalpha, dd, &arg1, &arg2);
 */
...
/**
 * @def LUA_EMBED_DUMMY
 * @brief Wrapper over LUA_EMBED_* autogenerated functions used to do nothing.
 * @param name Name of embedded lua function
 * @param type_codes Argument types for function - LUA_EMBED_XXX.
 * 
 * This macro wraps over LUA_EMBED_XXX.
 * It does nothing, could be used to create dummy for client-only stuff on server,
 * etc ..
 * Example:
 * @code
 * LUA_EMBED_DUMMY(texAlpha, dd);
 */
#define LUA_EMBED_DUMMY(name, type_codes) \
    LUA_EMBED_##type_codes(name, 0, {});

/**
 * @def LUA_EMBED_STD_CLIENT
 * @brief Wrapper over LUA_EMBED_* autogenerated functions used to bind a simple function call for client-only.
 * @param name Name of embedded lua function
 * @param func Name of function to call
 * @param type_codes Argument types for function - LUA_EMBED_XXX.
 * @param ... Specifies arguments themselves.
 * 
 * This macro wraps over LUA_EMBED_XXX.
 * It does LUA_EMBED_STD on client and LUA_EMBED_DUMMY on server.
 * @see LUA_EMBED_STD
 * @see LUA_EMBED_DUMMY
 * @see LUA_EMBED_STD_SERVER
 */
#ifdef CLIENT
#define LUA_EMBED_STD_CLIENT(...) LUA_EMBED_STD(__VA_ARGS__)
#else
#define LUA_EMBED_STD_CLIENT(name, func, type_codes, ...) LUA_EMBED_DUMMY(name, type_codes)
#endif

/**
 * @def LUA_EMBED_STD_SERVER
 * @brief Wrapper over LUA_EMBED_* autogenerated functions used to bind a simple function call for server-only.
 * @param name Name of embedded lua function
 * @param func Name of function to call
 * @param type_codes Argument types for function - LUA_EMBED_XXX.
 * @param ... Specifies arguments themselves.
 * 
 * This macro wraps over LUA_EMBED_XXX.
 * It does LUA_EMBED_STD on server and LUA_EMBED_DUMMY on client.
 * @see LUA_EMBED_STD
 * @see LUA_EMBED_DUMMY
 * @see LUA_EMBED_STD_CLIENT
 */
#ifdef SERVER
#define LUA_EMBED_STD_SERVER(...) LUA_EMBED_STD(__VA_ARGS__)
#else
#define LUA_EMBED_STD_SERVER(name, func, type_codes, ...) LUA_EMBED_DUMMY(name, type_codes)
#endif
