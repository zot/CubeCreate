...
luaL_Reg CAPI[] = {
	...
	STDREG(resetLightMaps),
	STDREG(calcLight),
	STDREG(patchLight),
	STDREG(clearLightMaps),
	STDREG(dumpLms),
#endif

	// blendmap
	STDREG(clearBlendBrushes),
	STDREG(delBlendBrush),
	STDREG(addBlendBrush),
	STDREG(nextBlendBrush),
	STDREG(setBlendBrush),
	STDREG(getBlendBrushName),
	STDREG(curBlendBrush),
	STDREG(rotateBlendBrush),
	STDREG(paintBlendMap),
	STDREG(clearBlendMapSel),
	STDREG(invertBlendMapSel),
	STDREG(invertBlendMap),
	STDREG(showBlendMap),
