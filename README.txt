...
THIS FILE IS HEAVILY BASED ON OLD README, NEEDS UPDATING.

Running
-------

To run the client and connect, run
...
See INSTALL for how to compile the source code, if binaries are not provided for your platform.
...
various setups (e.g., between connecting to CubeCreate or to your
...
compiling CubeCreate. You can also ask for help on IRC,

    #cubecreate on FreeNode
...
Please do so here:
    ...
    http://github.com/quaker66/CubeCreate/issues
...
CubeCreate will work fine if installed for all users. It
...
3. This distribution may contain sources or binaries of other open
   ...
   CubeCreate uses all of these project as-is, no changes
   have been made.
